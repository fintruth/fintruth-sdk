...
export class Initial1562784145322 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "city" character varying NOT NULL, "country" character varying NOT NULL, "line1" character varying NOT NULL, "line2" character varying NOT NULL DEFAULT '', "postalCode" character varying NOT NULL, "subdivision" character varying NOT NULL, "typeId" uuid NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "phone" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "countryId" uuid NOT NULL, "ext" character varying NOT NULL DEFAULT '', "isVerified" boolean NOT NULL DEFAULT false, "number" character varying NOT NULL, "typeId" uuid NOT NULL, CONSTRAINT "PK_f35e6ee6c1232ce6462505c2b25" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "profile" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "familyName" character varying NOT NULL, "givenName" character varying NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "REL_a24972ebd73b106250713dcddd" UNIQUE ("userId"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`)
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "isAdmin" boolean NOT NULL DEFAULT false, "password" character varying NOT NULL, "secret" character varying, "secretTemp" character varying, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`)
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "email" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "isPrimary" boolean NOT NULL DEFAULT false, "isVerified" boolean NOT NULL DEFAULT false, "userId" uuid NOT NULL, "value" character varying NOT NULL, CONSTRAINT "UQ_7c81dd76c75c30ad5713683ab2c" UNIQUE ("value"), CONSTRAINT "PK_1e7ed8734ee054ef18002e29b1c" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "media" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "mimeType" character varying NOT NULL, "name" character varying NOT NULL, "path" character varying NOT NULL, "typeId" uuid NOT NULL, CONSTRAINT "PK_f4e0fcac36e050de337b670d8bd" PRIMARY KEY ("id"))`)
