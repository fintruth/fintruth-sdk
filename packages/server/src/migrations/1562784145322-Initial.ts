...
export class Initial1562784145322 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS "email" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isPrimary" boolean NOT NULL DEFAULT false, "isVerified" boolean NOT NULL DEFAULT false, "userId" uuid NOT NULL, "value" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_7c81dd76c75c30ad5713683ab2c" UNIQUE ("value"), CONSTRAINT "PK_1e7ed8734ee054ef18002e29b1c" PRIMARY KEY ("id"))`)
